...
import 'addmeal_model.dart';
export 'addmeal_model.dart';
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<MealPlan2Record>>(
      ...
      builder: (context, snapshot) {
        ...
        List<MealPlan2Record> addmealMealPlan2RecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final addmealMealPlan2Record = addmealMealPlan2RecordList.isNotEmpty
            ? addmealMealPlan2RecordList.first
            : null;
        return Title(
            title: 'addmeal',
                                      ...
                                      children: [
                                        Expanded(
                                          child: FFButtonWidget(
                                            onPressed: () async {
                                              await MealPlan2Record.collection
                                                  .doc()
                                                  .set(
