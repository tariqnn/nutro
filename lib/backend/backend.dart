...
import 'schema/plantype_record.dart';
...
export 'schema/plantype_record.dart';
...
/// Functions to query PlantypeRecords (as a Stream and as a Future).
Future<int> queryPlantypeRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      PlantypeRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<PlantypeRecord>> queryPlantypeRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      PlantypeRecord.collection,
      PlantypeRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<PlantypeRecord>> queryPlantypeRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
